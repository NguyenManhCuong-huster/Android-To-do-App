...
import com.project3.todoapp.databinding.ItemCalendarDayBinding
...
class CalendarDayAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DayViewHolder {
        ...
        binding.root.layoutParams = RecyclerView.LayoutParams(w, ViewGroup.LayoutParams.WRAP_CONTENT)
    ...
    class DiffCallback : DiffUtil.ItemCallback<CalendarDayItem>() {
        override fun areItemsTheSame(o: CalendarDayItem, n: CalendarDayItem) = o.dayMillis == n.dayMillis
