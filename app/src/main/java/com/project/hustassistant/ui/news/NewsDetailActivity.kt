...
import com.project.hustassistant.databinding.ActivityNewsDetailBinding
import com.project.hustassistant.ui.aichat.AiChatActivity
import com.project.hustassistant.ui.common.AttachmentAdapter
...
class NewsDetailActivity : AppCompatActivity() {
    ...
    private fun bind(news: News) {
        ...
        binding.tvKind.setBackgroundResource(
            when (news.kind) {
                NewsKind.NEWS -> com.project.hustassistant.R.drawable.bg_news_kind_chip_news
                NewsKind.PLAN -> com.project.hustassistant.R.drawable.bg_news_kind_chip_plan
            }
        )
